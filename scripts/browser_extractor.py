...
class BrowserExtractor:
    ...
    def extract_safari_cookies(self, safari_path):
        ...
        # Safari uses binary cookies format which is complex to parse reliably
        # Skipping to avoid hanging the extraction process
        print("Safari cookie extraction skipped - binary format parsing is unreliable")
        return []
